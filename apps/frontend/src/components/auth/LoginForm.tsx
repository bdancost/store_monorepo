  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-sm text-white/40 mt-1">Acesse sua conta premium</p>
      </div>
      ...
      <div className="text-right">
        <span className="text-xs text-amber-400/60 cursor-pointer hover:text-amber-400 transition-colors">
          Esqueci a senha
        </span>
      </div>
